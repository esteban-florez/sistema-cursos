  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="{{ $type === 'student' ? 'col-md-4' : 'col-md-6' }}">
        <x-select name="gender" id="gender" :options="['' => 'Seleccionar...', 'female' => 'Femenino', 'male' => 'Masculino']" :selected="old('gender') ?? $gender ?? ''" required>
          Sexo:
        </x-select>
      </div>
      <div class="{{ $type === 'student' ? 'col-md-4' : 'col-md-6' }}">
      ...
      @if ($type === 'student')
      <div class="col-md-4">
        <x-select name="grade" id="grade" :options="['' => 'Seleccionar...', 'school' => 'Primaria', 'high' => 'Bachillerato', 'tsu' => 'TSU', 'college' => 'Pregrado']" :selected="old('grade') ?? $user->grade ?? ''" required>
