...
class CourseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Course::factory([
            ...
            'total_price' => 45,
            'start_ins' => $n->subDays(6),
            'end_ins' => $n->addDays(7),
            'start_course' => $n->addDays(8),
            'end_course' => $n->addDays(28),
            'duration' => 24,
            'student_limit' => 15,
            'start_time' => '08:00:00',
            'end_time' => '12:00:00',
        ...
        Course::factory([
            ...
            'start_ins' => $n->subDays(28),
            'end_ins' => $n->subDays(15),
            'start_course' => $n->subDays(14),
            'end_course' => $n->addDays(13),
            'duration' => 8,
            'start_time' => '14:00:00',
            'end_time' => '16:00:00',
            'days' => 'Sábado',
        ...
        Course::factory([
            ...
            'start_ins' => $n->subDays(35),
            'end_ins' => $n->subDays(22),
            'start_course' => $n->subDays(21),
            'end_course' => $n->subDays(1),
            'duration' => 16,
            'start_time' => '08:00:00',
            'end_time' => '12:00:00',
            'days' => 'Sábado',
