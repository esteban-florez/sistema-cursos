...
class UpdateCourseRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'image' => ['nullable', 'file', 'image', 'min:20', 'max:2048', 'exclude'],
            'user_id' => ['required', 'integer', 'numeric', 
                new ValidID],
            'area_id' => ['required', 'integer', 'numeric', 
                new ValidID],
            'description' => ['required', 'string', 'min:10', 'max:255'],
            'total_price' => ['required', 'integer', 'numeric', 'between:100,2000'],
            'reserv_price' => ['nullable', 'integer', 'numeric', 'between:50,350'],
